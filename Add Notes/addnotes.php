...
class addnotes extends BMPlugin 
{
	 ...
	 * Plugin constants
	 */
	private const PLUGIN_NAME 			= 'Add Notes';
	...
	public function OnReadLang(&$lang_user, &$lang_client, &$lang_custom, &$lang_admin, $lang): void
	{
		...
		$lang_admin['addnotes_text']		= 'Mit diesem Plugin können Sie Gruppen, einzelnen Benutzern oder direkt allen Benutzern, eine Notiz erstellen.';
	}
